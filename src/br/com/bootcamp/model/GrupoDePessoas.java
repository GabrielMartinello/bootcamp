...
public class GrupoDePessoas {
    ...
    private List<Pessoa2> grupoDePessoas = new ArrayList<>();
    private LocalDate dataAtual = LocalDate.now();

    public void AdicionaPessoas(Pessoa2 pessoa) {
        adicionaPessoasMaioresDe18Anos(pessoa);
    }

    private void adicionaPessoasMaioresDe18Anos(Pessoa2 pessoa) {
    ...
    private boolean verificaSePessoaTem18Anos(Pessoa2 pessoa) {
    ...
    private void retornaMaiorIdade() {
        if(!listaEstavazia()) {
            ...
            for (int i = 0; i < grupoDePessoas.size();i++){
                Pessoa2 pessoaAtual = grupoDePessoas.get(i);
    ...
    private void retornaMenorIdade() {
        if(!listaEstavazia()) {
            ...
            for (int i = 1;i < grupoDePessoas.size(); i++) {
                Pessoa2 pessoaAtual = grupoDePessoas.get(1);
    ...
    public List<Pessoa2> getPessoaList(){
